	...
	<div class="header_bottom">
	     	<div class="menu">
	     		<ul>
                    ...
                    <li class="active"><a href="haophi.php">Hao Phí Vật Tư</a></li>
		 ...
		 <?php 
			if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
			{
				...
				foreach ($_SESSION["cart_products"] as $cart_itm)
				{
					...
					echo '<td><strong>'.$cart_itm["macv"].'</strong></td>';
					echo '<td><strong>'.$cart_itm["tencv"].'</strong></td>';
					echo '<td><strong>'.$cart_itm["donvi"].'</strong></td>';
					if($cart_itm["khoiluong"]>0)echo '<td>'.$cart_itm["khoiluong"].'</td>';else echo '<td></td>';
					echo '<td></td>';
					echo '<td></td>';
					echo '<td></td>';
					echo '<td></td>';
				...
				for($i=0; $i<count($sp1); $i++)
					...
					echo '<td></td>';
					echo '<td></td>';
					if($cart_itm["khoiluong"]>0)echo '<td>'.$sp1[$i]['haophi']*$cart_itm["khoiluong"].'</td>';
					else echo '<td></td>';
					echo '<td></td>';
					echo '</tr>';
					}
